 ...
 */
final class Version20260207074308 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE aliment (id INT AUTO_INCREMENT NOT NULL, nom_aliment VARCHAR(100) NOT NULL, calories INT NOT NULL, index_glycemique INT NOT NULL, est_excitant TINYINT(1) NOT NULL, repas_id INT NOT NULL, INDEX IDX_70FF972B1D236AAA (repas_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4');
        $this->addSql('CREATE TABLE consultation (id INT AUTO_INCREMENT NOT NULL, date_consultation DATETIME NOT NULL, symptomes LONGTEXT NOT NULL, diagnostic LONGTEXT NOT NULL, recommandations LONGTEXT NOT NULL, rendezvous_id INT NOT NULL, UNIQUE INDEX UNIQ_964685A63345E0A3 (rendezvous_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4');
