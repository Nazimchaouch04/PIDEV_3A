 ...
 */
final class Version20260508220552 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE alerte (id INT AUTO_INCREMENT NOT NULL, type VARCHAR(100) NOT NULL, message LONGTEXT NOT NULL, date_alerte DATETIME NOT NULL, criticite VARCHAR(50) NOT NULL, utilisateur_id INT NOT NULL, repas_id INT DEFAULT NULL, INDEX IDX_3AE753AFB88E14F (utilisateur_id), INDEX IDX_3AE753A1D236AAA (repas_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4');
        ...
        $this->addSql('CREATE TABLE cognitive_insight (id INT AUTO_INCREMENT NOT NULL, analyse LONGTEXT NOT NULL, humeur_predite VARCHAR(50) NOT NULL, scores_evolution JSON NOT NULL, date_analyse DATETIME NOT NULL, utilisateur_id INT NOT NULL, INDEX IDX_470C59A1FB88E14F (utilisateur_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4');
        ...
        $this->addSql('CREATE TABLE exercice (id INT AUTO_INCREMENT NOT NULL, nom_exercice VARCHAR(100) NOT NULL, intensite VARCHAR(255) NOT NULL, calories_par_minute NUMERIC(5, 2) NOT NULL, seance_id INT NOT NULL, INDEX IDX_E418C74DE3797A94 (seance_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4');
        ...
        $this->addSql('CREATE TABLE mental_check_in (id INT AUTO_INCREMENT NOT NULL, humeur VARCHAR(50) NOT NULL, niveau_energie INT NOT NULL, note_personnelle LONGTEXT DEFAULT NULL, date_check_in DATETIME NOT NULL, reponse_coach LONGTEXT DEFAULT NULL, utilisateur_id INT NOT NULL, INDEX IDX_B0CA2918FB88E14F (utilisateur_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4');
        ...
        $this->addSql('CREATE TABLE seance_sport (id INT AUTO_INCREMENT NOT NULL, nom_seance VARCHAR(100) NOT NULL, heure_debut TIME NOT NULL, duree_minutes INT NOT NULL, medaille_obtenue VARCHAR(50) DEFAULT NULL, date_seance DATE NOT NULL, heure_debut_reelle DATETIME DEFAULT NULL, alerte_envoyee TINYINT(1) NOT NULL, utilisateur_id INT NOT NULL, INDEX IDX_593FC9EFB88E14F (utilisateur_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4');
        ...
        $this->addSql('CREATE TABLE utilisateur (id INT AUTO_INCREMENT NOT NULL, nom_complet VARCHAR(100) NOT NULL, email VARCHAR(100) NOT NULL, mot_de_passe VARCHAR(255) NOT NULL, score_global INT NOT NULL, date_inscription DATE NOT NULL, roles JSON NOT NULL, reset_token VARCHAR(255) DEFAULT NULL, reset_token_expires_at DATETIME DEFAULT NULL, face_encoding JSON DEFAULT NULL, photo VARCHAR(255) DEFAULT NULL, UNIQUE INDEX UNIQ_1D1C63B3E7927C74 (email), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4');
        ...
        $this->addSql('ALTER TABLE cognitive_insight ADD CONSTRAINT FK_470C59A1FB88E14F FOREIGN KEY (utilisateur_id) REFERENCES utilisateur (id)');
        ...
        $this->addSql('ALTER TABLE log_event ADD CONSTRAINT FK_1BD0E1FAFB88E14F FOREIGN KEY (utilisateur_id) REFERENCES utilisateur (id) ON DELETE SET NULL');
        ...
        $this->addSql('ALTER TABLE mental_check_in ADD CONSTRAINT FK_B0CA2918FB88E14F FOREIGN KEY (utilisateur_id) REFERENCES utilisateur (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE cognitive_insight DROP FOREIGN KEY FK_470C59A1FB88E14F');
        ...
        $this->addSql('ALTER TABLE mental_check_in DROP FOREIGN KEY FK_B0CA2918FB88E14F');
        ...
        $this->addSql('DROP TABLE mental_check_in');
