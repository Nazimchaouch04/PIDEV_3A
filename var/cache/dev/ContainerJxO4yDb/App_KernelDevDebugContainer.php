...
class App_KernelDevDebugContainer extends Container
{
    ...
    public function __construct(private array $buildParameters = [], protected string $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            'App\\Controller\\Admin\\NutritionAdminController' => 'getNutritionAdminControllerService',
            'App\\Controller\\AlimentController' => 'getAlimentControllerService',
            ...
            'App\\Controller\\MedicalController' => 'getMedicalControllerService',
            'App\\Controller\\MentalAdminController' => 'getMentalAdminControllerService',
            'App\\Controller\\MentalController' => 'getMentalControllerService',
            'App\\Controller\\NutritionController' => 'getNutritionControllerService',
            'App\\Controller\\ProfileController' => 'getProfileControllerService',
            'App\\Controller\\RepasController' => 'getRepasControllerService',
            'App\\Controller\\SecurityController' => 'getSecurityControllerService',
            'App\\Controller\\SportsController' => 'getSportsControllerService',
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('TB4D0tJAt+', 0, ($container->targetDir.''.'/pools/app'), ($container->privates['cache.default_marshaller'] ??= new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL, true)));
    ...
    {
        return $container->services['cache.security_is_csrf_token_valid_attribute_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('OCm4IqXTua', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        return $container->services['cache.security_is_granted_attribute_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('CHD16HVvUL', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        return $container->services['cache.system'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('TXtmGOpvkL', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        return $container->services['cache.validator_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('iblIXdVcET', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    protected static function getHttpKernelService($container)
    {
        ...
        $b->allowControllers(['App\\Kernel', 'App\\Controller\\Admin\\NutritionAdminController', 'App\\Controller\\AlimentController', 'App\\Controller\\CertificationController', 'App\\Controller\\CommunityController', 'App\\Controller\\DashboardController', 'App\\Controller\\LandingController', 'App\\Controller\\MedicalController', 'App\\Controller\\MentalAdminController', 'App\\Controller\\MentalController', 'App\\Controller\\NutritionController', 'App\\Controller\\ProfileController', 'App\\Controller\\RepasController', 'App\\Controller\\SecurityController', 'App\\Controller\\SportsController', 'Doctrine\\Bundle\\DoctrineBundle\\Controller\\ProfilerController']);
    ...
    protected static function getAssetMapperService($container)
    {
        ...
        }, 4), #[\Closure(name: 'asset_mapper', class: 'Symfony\\Component\\AssetMapper\\AssetMapper')] fn () => ($container->privates['asset_mapper'] ?? self::getAssetMapperService($container))), 'C:\\biosync_new/assets/vendor'), ($container->targetDir.''.'/asset_mapper'), true), ($container->privates['asset_mapper.compiled_asset_mapper_config_reader'] ??= new \Symfony\Component\AssetMapper\CompiledAssetMapperConfigReader('C:\\biosync_new/public/assets')));
    }
    ...
    {
        return $container->privates['asset_mapper.repository'] = new \Symfony\Component\AssetMapper\AssetMapperRepository(['C:\\biosync_new\\vendor\\symfony\\ux-turbo\\src\\DependencyInjection/../../assets/dist' => '@symfony/ux-turbo', 'C:\\biosync_new\\vendor\\symfony\\stimulus-bundle\\src\\DependencyInjection/../../assets/dist' => '@symfony/stimulus-bundle', 'assets/' => ''], 'C:\\biosync_new', ['#^(?=[^\\.]).*\\.d\\.ts$#', '#^(?=[^\\.]).*.*/(?=[^\\.])controllers\\.json$#'], true, true);
    }
    ...
    {
        return $container->privates['cache.asset_mapper'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('41RuOS3CyE', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('7nJslYkO60', 0, ($container->targetDir.''.'/pools/app'), ($container->privates['cache.default_marshaller'] ??= new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL, true)));
        $a->setLogger(($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container)));
    ...
    {
        return $container->privates['cache.security_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('FaYK9nmYIv', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        return $container->privates['cache.security_token_verifier'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('3qV+30FtrS', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        return $container->privates['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('3YY9gsrOBh', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        return $container->privates['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('7qU-j2160L', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        return $container->privates['debug.file_link_formatter'] = new \Symfony\Component\ErrorHandler\ErrorRenderer\FileLinkFormatter($container->getEnv('default::SYMFONY_IDE'), ($container->services['request_stack'] ??= new \Symfony\Component\HttpFoundation\RequestStack()), 'C:\\biosync_new', #[\Closure(name: 'debug.file_link_formatter.url_format', class: 'string')] fn () => ($container->privates['debug.file_link_formatter.url_format'] ?? $container->load('getDebug_FileLinkFormatter_UrlFormatService')));
    }
    ...
    protected static function getDoctrine_Orm_DefaultConfigurationService($container)
    {
        ...
        $a->addDriver(($container->privates['doctrine.orm.default_attribute_metadata_driver'] ??= new \Doctrine\ORM\Mapping\Driver\AttributeDriver(['C:\\biosync_new\\src\\Entity'], true)), 'App\\Entity');
        ...
        $instance->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService ??= $container->getService(...), [
            'App\\Repository\\AlimentRepository' => ['privates', 'App\\Repository\\AlimentRepository', 'getAlimentRepositoryService', true],
            'App\\Repository\\EvenementSanteRepository' => ['privates', 'App\\Repository\\EvenementSanteRepository', 'getEvenementSanteRepositoryService', true],
            'App\\Repository\\ExerciceRepository' => ['privates', 'App\\Repository\\ExerciceRepository', 'getExerciceRepositoryService', true],
            'App\\Repository\\GroupeSoutienRepository' => ['privates', 'App\\Repository\\GroupeSoutienRepository', 'getGroupeSoutienRepositoryService', true],
            'App\\Repository\\MembreGroupeRepository' => ['privates', 'App\\Repository\\MembreGroupeRepository', 'getMembreGroupeRepositoryService', true],
            'App\\Repository\\ProfilSanteRepository' => ['privates', 'App\\Repository\\ProfilSanteRepository', 'getProfilSanteRepositoryService', true],
            'App\\Repository\\QuestionRepository' => ['privates', 'App\\Repository\\QuestionRepository', 'getQuestionRepositoryService', true],
            'App\\Repository\\QuizMentalRepository' => ['privates', 'App\\Repository\\QuizMentalRepository', 'getQuizMentalRepositoryService', true],
            ...
            'App\\Repository\\SeanceSportRepository' => ['privates', 'App\\Repository\\SeanceSportRepository', 'getSeanceSportRepositoryService', true],
            'App\\Repository\\SpecialisteRepository' => ['privates', 'App\\Repository\\SpecialisteRepository', 'getSpecialisteRepositoryService', true],
            'App\\Repository\\UtilisateurRepository' => ['privates', 'App\\Repository\\UtilisateurRepository', 'getUtilisateurRepositoryService', true],
        ], [
            'App\\Repository\\AlimentRepository' => '?',
            'App\\Repository\\EvenementSanteRepository' => '?',
            'App\\Repository\\ExerciceRepository' => '?',
            'App\\Repository\\GroupeSoutienRepository' => '?',
            'App\\Repository\\MembreGroupeRepository' => '?',
            'App\\Repository\\ProfilSanteRepository' => '?',
            'App\\Repository\\QuestionRepository' => '?',
            'App\\Repository\\QuizMentalRepository' => '?',
            'App\\Repository\\RendezVousRepository' => '?',
            'App\\Repository\\RepasRepository' => '?',
            'App\\Repository\\SeanceSportRepository' => '?',
            'App\\Repository\\SpecialisteRepository' => '?',
    ...
    {
        return $container->privates['router_listener'] = new \Symfony\Component\HttpKernel\EventListener\RouterListener(($container->services['router'] ?? self::getRouterService($container)), ($container->services['request_stack'] ??= new \Symfony\Component\HttpFoundation\RequestStack()), ($container->privates['router.request_context'] ?? self::getRouter_RequestContextService($container)), ($container->privates['monolog.logger.request'] ?? self::getMonolog_Logger_RequestService($container)), 'C:\\biosync_new', true);
    }
    ...
    protected static function getTranslator_DefaultService($container)
    {
        ...
        ]), new \Symfony\Component\Translation\Formatter\MessageFormatter(new \Symfony\Component\Translation\IdentityTranslator()), 'en', ['translation.loader.php' => ['php'], 'translation.loader.yml' => ['yaml', 'yml'], 'translation.loader.xliff' => ['xlf', 'xliff'], 'translation.loader.po' => ['po'], 'translation.loader.mo' => ['mo'], 'translation.loader.qt' => ['ts'], 'translation.loader.csv' => ['csv'], 'translation.loader.res' => ['res'], 'translation.loader.dat' => ['dat'], 'translation.loader.ini' => ['ini'], 'translation.loader.json' => ['json']], ['cache_dir' => ($container->targetDir.''.'/translations'), 'debug' => true, 'resource_files' => ['af' => ['C:\\biosync_new\\vendor\\symfony\\validator/Resources/translations\\validators.af.xlf', 'C:\\biosync_new\\vendor\\symfony\\form/Resources/translations\\validators.af.xlf', 'C:\\biosync_new\\vendor\\symfony\\security-core/Resources/translations\\security.af.xlf'], 'ar' => ['C:\\biosync_new\\vendor\\symfony\\validator/Resources/translations\\validators.ar.xlf', 'C:\\biosync_new\\vendor\\symfony\\form/Resources/translations\\validators.ar.xlf', 'C:\\biosync_new\\vendor\\symfony\\security-core/Resources/translations\\security.ar.xlf'], 'az' => ['C:\\biosync_new\\vendor\\symfony\\validator/Resources/translations\\validators.az.xlf', 'C:\\biosync_new\\vendor\\symfony\\form/Resources/translations\\validators.az.xlf', 'C:\\biosync_new\\vendor\\symfony\\security-core/Resources/translations\\security.az.xlf'], 'be' => ['C:\\biosync_new\\vendor\\symfony\\validator/Resources/translations\\validators.be.xlf', 'C:\\biosync_new\\vendor\\symfony\\form/Resources/translations\\validators.be.xlf', 'C:\\biosync_new\\vendor\\symfony\\security-core/Resources/translations\\security.be.xlf'], 'bg' => ['C:\\biosync_new\\vendor\\symfony\\validator/Resources/translations\\validators.bg.xlf', 'C:\\biosync_new\\vendor\\symfony\\form/Resources/translations\\validators.bg.xlf', 'C:\\biosync_new\\vendor\\symfony\\security-core/Resources/translations\\security.bg.xlf'], 'bs' => ['C:\\biosync_new\\vendor\\symfony\\validator/Resources/translations\\validators.bs.xlf', 'C:\\biosync_new\\vendor\\symfony\\form/Resources/translations\\validators.bs.xlf', 'C:\\biosync_new\\vendor\\symfony\\security-core/Resources/translations\\security.bs.xlf'], 'ca' => ['C:\\biosync_new\\vendor\\symfony\\validator/Resources/translations\\validators.ca.xlf', 'C:\\biosync_new\\vendor\\symfony\\form/Resources/translations\\validators.ca.xlf', 'C:\\biosync_new\\vendor\\symfony\\security-core/Resources/translations\\security.ca.xlf'], 'cs' => ['C:\\biosync_new\\vendor\\symfony\\validator/Resources/translations\\validators.cs.xlf', 'C:\\biosync_new\\vendor\\symfony\\form/Resources/translations\\validators.cs.xlf', 'C:\\biosync_new\\vendor\\symfony\\security-core/Resources/translations\\security.cs.xlf'], 'cy' => ['C:\\biosync_new\\vendor\\symfony\\validator/Resources/translations\\validators.cy.xlf', 'C:\\biosync_new\\vendor\\symfony\\form/Resources/translations\\validators.cy.xlf', 'C:\\biosync_new\\vendor\\symfony\\security-core/Resources/translations\\security.cy.xlf'], 'da' => ['C:\\biosync_new\\vendor\\symfony\\validator/Resources/translations\\validators.da.xlf', 'C:\\biosync_new\\vendor\\symfony\\form/Resources/translations\\validators.da.xlf', 'C:\\biosync_new\\vendor\\symfony\\security-core/Resources/translations\\security.da.xlf'], 'de' => ['C:\\biosync_new\\vendor\\symfony\\validator/Resources/translations\\validators.de.xlf', 'C:\\biosync_new\\vendor\\symfony\\form/Resources/translations\\validators.de.xlf', 'C:\\biosync_new\\vendor\\symfony\\security-core/Resources/translations\\security.de.xlf'], 'el' => ['C:\\biosync_new\\vendor\\symfony\\validator/Resources/translations\\validators.el.xlf', 'C:\\biosync_new\\vendor\\symfony\\form/Resources/translations\\validators.el.xlf', 'C:\\biosync_new\\vendor\\symfony\\security-core/Resources/translations\\security.el.xlf'], 'en' => ['C:\\biosync_new\\vendor\\symfony\\validator/Resources/translations\\validators.en.xlf', 'C:\\biosync_new\\vendor\\symfony\\form/Resources/translations\\validators.en.xlf', 'C:\\biosync_new\\vendor\\symfony\\security-core/Resources/translations\\security.en.xlf'], 'es' => ['C:\\biosync_new\\vendor\\symfony\\validator/Resources/translations\\validators.es.xlf', 'C:\\biosync_new\\vendor\\symfony\\form/Resources/translations\\validators.es.xlf', 'C:\\biosync_new\\vendor\\symfony\\security-core/Resources/translations\\security.es.xlf'], 'et' => ['C:\\biosync_new\\vendor\\symfony\\validator/Resources/translations\\validators.et.xlf', 'C:\\biosync_new\\vendor\\symfony\\form/Resources/translations\\validators.et.xlf', 'C:\\biosync_new\\vendor\\symfony\\security-core/Resources/translations\\security.et.xlf'], 'eu' => ['C:\\biosync_new\\vendor\\symfony\\validator/Resources/translations\\validators.eu.xlf', 'C:\\biosync_new\\vendor\\symfony\\form/Resources/translations\\validators.eu.xlf', 'C:\\biosync_new\\vendor\\symfony\\security-core/Resources/translations\\security.eu.xlf'], 'fa' => ['C:\\biosync_new\\vendor\\symfony\\validator/Resources/translations\\validators.fa.xlf', 'C:\\biosync_new\\vendor\\symfony\\form/Resources/translations\\validators.fa.xlf', 'C:\\biosync_new\\vendor\\symfony\\security-core/Resources/translations\\security.fa.xlf'], 'fi' => ['C:\\biosync_new\\vendor\\symfony\\validator/Resources/translations\\validators.fi.xlf', 'C:\\biosync_new\\vendor\\symfony\\form/Resources/translations\\validators.fi.xlf', 'C:\\biosync_new\\vendor\\symfony\\security-core/Resources/translations\\security.fi.xlf'], 'fr' => ['C:\\biosync_new\\vendor\\symfony\\validator/Resources/translations\\validators.fr.xlf', 'C:\\biosync_new\\vendor\\symfony\\form/Resources/translations\\validators.fr.xlf', 'C:\\biosync_new\\vendor\\symfony\\security-core/Resources/translations\\security.fr.xlf'], 'gl' => ['C:\\biosync_new\\vendor\\symfony\\validator/Resources/translations\\validators.gl.xlf', 'C:\\biosync_new\\vendor\\symfony\\form/Resources/translations\\validators.gl.xlf', 'C:\\biosync_new\\vendor\\symfony\\security-core/Resources/translations\\security.gl.xlf'], 'he' => ['C:\\biosync_new\\vendor\\symfony\\validator/Resources/translations\\validators.he.xlf', 'C:\\biosync_new\\vendor\\symfony\\form/Resources/translations\\validators.he.xlf', 'C:\\biosync_new\\vendor\\symfony\\security-core/Resources/translations\\security.he.xlf'], 'hr' => ['C:\\biosync_new\\vendor\\symfony\\validator/Resources/translations\\validators.hr.xlf', 'C:\\biosync_new\\vendor\\symfony\\form/Resources/translations\\validators.hr.xlf', 'C:\\biosync_new\\vendor\\symfony\\security-core/Resources/translations\\security.hr.xlf'], 'hu' => ['C:\\biosync_new\\vendor\\symfony\\validator/Resources/translations\\validators.hu.xlf', 'C:\\biosync_new\\vendor\\symfony\\form/Resources/translations\\validators.hu.xlf', 'C:\\biosync_new\\vendor\\symfony\\security-core/Resources/translations\\security.hu.xlf'], 'hy' => ['C:\\biosync_new\\vendor\\symfony\\validator/Resources/translations\\validators.hy.xlf', 'C:\\biosync_new\\vendor\\symfony\\form/Resources/translations\\validators.hy.xlf', 'C:\\biosync_new\\vendor\\symfony\\security-core/Resources/translations\\security.hy.xlf'], 'id' => ['C:\\biosync_new\\vendor\\symfony\\validator/Resources/translations\\validators.id.xlf', 'C:\\biosync_new\\vendor\\symfony\\form/Resources/translations\\validators.id.xlf', 'C:\\biosync_new\\vendor\\symfony\\security-core/Resources/translations\\security.id.xlf'], 'it' => ['C:\\biosync_new\\vendor\\symfony\\validator/Resources/translations\\validators.it.xlf', 'C:\\biosync_new\\vendor\\symfony\\form/Resources/translations\\validators.it.xlf', 'C:\\biosync_new\\vendor\\symfony\\security-core/Resources/translations\\security.it.xlf'], 'ja' => ['C:\\biosync_new\\vendor\\symfony\\validator/Resources/translations\\validators.ja.xlf', 'C:\\biosync_new\\vendor\\symfony\\form/Resources/translations\\validators.ja.xlf', 'C:\\biosync_new\\vendor\\symfony\\security-core/Resources/translations\\security.ja.xlf'], 'lb' => ['C:\\biosync_new\\vendor\\symfony\\validator/Resources/translations\\validators.lb.xlf', 'C:\\biosync_new\\vendor\\symfony\\form/Resources/translations\\validators.lb.xlf', 'C:\\biosync_new\\vendor\\symfony\\security-core/Resources/translations\\security.lb.xlf'], 'lt' => ['C:\\biosync_new\\vendor\\symfony\\validator/Resources/translations\\validators.lt.xlf', 'C:\\biosync_new\\vendor\\symfony\\form/Resources/translations\\validators.lt.xlf', 'C:\\biosync_new\\vendor\\symfony\\security-core/Resources/translations\\security.lt.xlf'], 'lv' => ['C:\\biosync_new\\vendor\\symfony\\validator/Resources/translations\\validators.lv.xlf', 'C:\\biosync_new\\vendor\\symfony\\form/Resources/translations\\validators.lv.xlf', 'C:\\biosync_new\\vendor\\symfony\\security-core/Resources/translations\\security.lv.xlf'], 'mk' => ['C:\\biosync_new\\vendor\\symfony\\validator/Resources/translations\\validators.mk.xlf', 'C:\\biosync_new\\vendor\\symfony\\form/Resources/translations\\validators.mk.xlf', 'C:\\biosync_new\\vendor\\symfony\\security-core/Resources/translations\\security.mk.xlf'], 'mn' => ['C:\\biosync_new\\vendor\\symfony\\validator/Resources/translations\\validators.mn.xlf', 'C:\\biosync_new\\vendor\\symfony\\form/Resources/translations\\validators.mn.xlf', 'C:\\biosync_new\\vendor\\symfony\\security-core/Resources/translations\\security.mn.xlf'], 'my' => ['C:\\biosync_new\\vendor\\symfony\\validator/Resources/translations\\validators.my.xlf', 'C:\\biosync_new\\vendor\\symfony\\form/Resources/translations\\validators.my.xlf', 'C:\\biosync_new\\vendor\\symfony\\security-core/Resources/translations\\security.my.xlf'], 'nb' => ['C:\\biosync_new\\vendor\\symfony\\validator/Resources/translations\\validators.nb.xlf', 'C:\\biosync_new\\vendor\\symfony\\form/Resources/translations\\validators.nb.xlf', 'C:\\biosync_new\\vendor\\symfony\\security-core/Resources/translations\\security.nb.xlf'], 'nl' => ['C:\\biosync_new\\vendor\\symfony\\validator/Resources/translations\\validators.nl.xlf', 'C:\\biosync_new\\vendor\\symfony\\form/Resources/translations\\validators.nl.xlf', 'C:\\biosync_new\\vendor\\symfony\\security-core/Resources/translations\\security.nl.xlf'], 'nn' => ['C:\\biosync_new\\vendor\\symfony\\validator/Resources/translations\\validators.nn.xlf', 'C:\\biosync_new\\vendor\\symfony\\form/Resources/translations\\validators.nn.xlf', 'C:\\biosync_new\\vendor\\symfony\\security-core/Resources/translations\\security.nn.xlf'], 'no' => ['C:\\biosync_new\\vendor\\symfony\\validator/Resources/translations\\validators.no.xlf', 'C:\\biosync_new\\vendor\\symfony\\form/Resources/translations\\validators.no.xlf', 'C:\\biosync_new\\vendor\\symfony\\security-core/Resources/translations\\security.no.xlf'], 'pl' => ['C:\\biosync_new\\vendor\\symfony\\validator/Resources/translations\\validators.pl.xlf', 'C:\\biosync_new\\vendor\\symfony\\form/Resources/translations\\validators.pl.xlf', 'C:\\biosync_new\\vendor\\symfony\\security-core/Resources/translations\\security.pl.xlf'], 'pt' => ['C:\\biosync_new\\vendor\\symfony\\validator/Resources/translations\\validators.pt.xlf', 'C:\\biosync_new\\vendor\\symfony\\form/Resources/translations\\validators.pt.xlf', 'C:\\biosync_new\\vendor\\symfony\\security-core/Resources/translations\\security.pt.xlf'], 'pt_BR' => ['C:\\biosync_new\\vendor\\symfony\\validator/Resources/translations\\validators.pt_BR.xlf', 'C:\\biosync_new\\vendor\\symfony\\form/Resources/translations\\validators.pt_BR.xlf', 'C:\\biosync_new\\vendor\\symfony\\security-core/Resources/translations\\security.pt_BR.xlf'], 'ro' => ['C:\\biosync_new\\vendor\\symfony\\validator/Resources/translations\\validators.ro.xlf', 'C:\\biosync_new\\vendor\\symfony\\form/Resources/translations\\validators.ro.xlf', 'C:\\biosync_new\\vendor\\symfony\\security-core/Resources/translations\\security.ro.xlf'], 'ru' => ['C:\\biosync_new\\vendor\\symfony\\validator/Resources/translations\\validators.ru.xlf', 'C:\\biosync_new\\vendor\\symfony\\form/Resources/translations\\validators.ru.xlf', 'C:\\biosync_new\\vendor\\symfony\\security-core/Resources/translations\\security.ru.xlf'], 'sk' => ['C:\\biosync_new\\vendor\\symfony\\validator/Resources/translations\\validators.sk.xlf', 'C:\\biosync_new\\vendor\\symfony\\form/Resources/translations\\validators.sk.xlf', 'C:\\biosync_new\\vendor\\symfony\\security-core/Resources/translations\\security.sk.xlf'], 'sl' => ['C:\\biosync_new\\vendor\\symfony\\validator/Resources/translations\\validators.sl.xlf', 'C:\\biosync_new\\vendor\\symfony\\form/Resources/translations\\validators.sl.xlf', 'C:\\biosync_new\\vendor\\symfony\\security-core/Resources/translations\\security.sl.xlf'], 'sq' => ['C:\\biosync_new\\vendor\\symfony\\validator/Resources/translations\\validators.sq.xlf', 'C:\\biosync_new\\vendor\\symfony\\form/Resources/translations\\validators.sq.xlf', 'C:\\biosync_new\\vendor\\symfony\\security-core/Resources/translations\\security.sq.xlf'], 'sr_Cyrl' => ['C:\\biosync_new\\vendor\\symfony\\validator/Resources/translations\\validators.sr_Cyrl.xlf', 'C:\\biosync_new\\vendor\\symfony\\form/Resources/translations\\validators.sr_Cyrl.xlf', 'C:\\biosync_new\\vendor\\symfony\\security-core/Resources/translations\\security.sr_Cyrl.xlf'], 'sr_Latn' => ['C:\\biosync_new\\vendor\\symfony\\validator/Resources/translations\\validators.sr_Latn.xlf', 'C:\\biosync_new\\vendor\\symfony\\form/Resources/translations\\validators.sr_Latn.xlf', 'C:\\biosync_new\\vendor\\symfony\\security-core/Resources/translations\\security.sr_Latn.xlf'], 'sv' => ['C:\\biosync_new\\vendor\\symfony\\validator/Resources/translations\\validators.sv.xlf', 'C:\\biosync_new\\vendor\\symfony\\form/Resources/translations\\validators.sv.xlf', 'C:\\biosync_new\\vendor\\symfony\\security-core/Resources/translations\\security.sv.xlf'], 'th' => ['C:\\biosync_new\\vendor\\symfony\\validator/Resources/translations\\validators.th.xlf', 'C:\\biosync_new\\vendor\\symfony\\form/Resources/translations\\validators.th.xlf', 'C:\\biosync_new\\vendor\\symfony\\security-core/Resources/translations\\security.th.xlf'], 'tl' => ['C:\\biosync_new\\vendor\\symfony\\validator/Resources/translations\\validators.tl.xlf', 'C:\\biosync_new\\vendor\\symfony\\form/Resources/translations\\validators.tl.xlf', 'C:\\biosync_new\\vendor\\symfony\\security-core/Resources/translations\\security.tl.xlf'], 'tr' => ['C:\\biosync_new\\vendor\\symfony\\validator/Resources/translations\\validators.tr.xlf', 'C:\\biosync_new\\vendor\\symfony\\form/Resources/translations\\validators.tr.xlf', 'C:\\biosync_new\\vendor\\symfony\\security-core/Resources/translations\\security.tr.xlf'], 'uk' => ['C:\\biosync_new\\vendor\\symfony\\validator/Resources/translations\\validators.uk.xlf', 'C:\\biosync_new\\vendor\\symfony\\form/Resources/translations\\validators.uk.xlf', 'C:\\biosync_new\\vendor\\symfony\\security-core/Resources/translations\\security.uk.xlf'], 'ur' => ['C:\\biosync_new\\vendor\\symfony\\validator/Resources/translations\\validators.ur.xlf', 'C:\\biosync_new\\vendor\\symfony\\form/Resources/translations\\validators.ur.xlf', 'C:\\biosync_new\\vendor\\symfony\\security-core/Resources/translations\\security.ur.xlf'], 'uz' => ['C:\\biosync_new\\vendor\\symfony\\validator/Resources/translations\\validators.uz.xlf', 'C:\\biosync_new\\vendor\\symfony\\form/Resources/translations\\validators.uz.xlf', 'C:\\biosync_new\\vendor\\symfony\\security-core/Resources/translations\\security.uz.xlf'], 'vi' => ['C:\\biosync_new\\vendor\\symfony\\validator/Resources/translations\\validators.vi.xlf', 'C:\\biosync_new\\vendor\\symfony\\form/Resources/translations\\validators.vi.xlf', 'C:\\biosync_new\\vendor\\symfony\\security-core/Resources/translations\\security.vi.xlf'], 'zh_CN' => ['C:\\biosync_new\\vendor\\symfony\\validator/Resources/translations\\validators.zh_CN.xlf', 'C:\\biosync_new\\vendor\\symfony\\form/Resources/translations\\validators.zh_CN.xlf', 'C:\\biosync_new\\vendor\\symfony\\security-core/Resources/translations\\security.zh_CN.xlf'], 'zh_TW' => ['C:\\biosync_new\\vendor\\symfony\\validator/Resources/translations\\validators.zh_TW.xlf', 'C:\\biosync_new\\vendor\\symfony\\form/Resources/translations\\validators.zh_TW.xlf', 'C:\\biosync_new\\vendor\\symfony\\security-core/Resources/translations\\security.zh_TW.xlf']], 'scanned_directories' => ['C:\\biosync_new\\vendor\\symfony\\validator/Resources/translations', 'C:\\biosync_new\\vendor\\symfony\\form/Resources/translations', 'C:\\biosync_new\\vendor\\symfony\\security-core/Resources/translations', 'C:\\biosync_new/translations', 'C:\\biosync_new\\vendor\\symfony\\framework-bundle/translations', 'C:\\biosync_new\\vendor\\doctrine\\doctrine-bundle/translations', 'C:\\biosync_new\\vendor\\doctrine\\doctrine-migrations-bundle/translations', 'C:\\biosync_new\\vendor\\symfony\\debug-bundle/translations', 'C:\\biosync_new\\vendor\\symfony\\twig-bundle/translations', 'C:\\biosync_new\\vendor\\symfony\\web-profiler-bundle/translations', 'C:\\biosync_new\\vendor\\symfony\\stimulus-bundle/translations', 'C:\\biosync_new\\vendor\\symfony\\ux-turbo/translations', 'C:\\biosync_new\\vendor\\twig\\extra-bundle/translations', 'C:\\biosync_new\\vendor\\symfony\\security-bundle/translations', 'C:\\biosync_new\\vendor\\symfony\\monolog-bundle\\src/translations', 'C:\\biosync_new\\vendor\\symfony\\maker-bundle/translations', 'C:\\biosync_new\\vendor\\doctrine\\doctrine-fixtures-bundle/translations'], 'cache_vary' => ['scanned_directories' => ['C:\\biosync_new\\vendor\\symfony\\validator/Resources/translations', 'C:\\biosync_new\\vendor\\symfony\\form/Resources/translations', 'C:\\biosync_new\\vendor\\symfony\\security-core/Resources/translations', 'translations', 'C:\\biosync_new\\vendor\\symfony\\framework-bundle/translations', 'C:\\biosync_new\\vendor\\doctrine\\doctrine-bundle/translations', 'C:\\biosync_new\\vendor\\doctrine\\doctrine-migrations-bundle/translations', 'C:\\biosync_new\\vendor\\symfony\\debug-bundle/translations', 'C:\\biosync_new\\vendor\\symfony\\twig-bundle/translations', 'C:\\biosync_new\\vendor\\symfony\\web-profiler-bundle/translations', 'C:\\biosync_new\\vendor\\symfony\\stimulus-bundle/translations', 'C:\\biosync_new\\vendor\\symfony\\ux-turbo/translations', 'C:\\biosync_new\\vendor\\twig\\extra-bundle/translations', 'C:\\biosync_new\\vendor\\symfony\\security-bundle/translations', 'C:\\biosync_new\\vendor\\symfony\\monolog-bundle\\src/translations', 'C:\\biosync_new\\vendor\\symfony\\maker-bundle/translations', 'C:\\biosync_new\\vendor\\doctrine\\doctrine-fixtures-bundle/translations']]], []);
    ...
    {
        $a = new \Twig\Loader\FilesystemLoader([], 'C:\\biosync_new');
        $a->addPath('C:\\biosync_new\\vendor\\doctrine\\doctrine-bundle/templates', 'Doctrine');
        $a->addPath('C:\\biosync_new\\vendor\\doctrine\\doctrine-bundle/templates', '!Doctrine');
        $a->addPath('C:\\biosync_new\\vendor\\doctrine\\doctrine-migrations-bundle/templates', 'DoctrineMigrations');
        $a->addPath('C:\\biosync_new\\vendor\\doctrine\\doctrine-migrations-bundle/templates', '!DoctrineMigrations');
        $a->addPath('C:\\biosync_new\\vendor\\symfony\\debug-bundle/Resources/views', 'Debug');
        $a->addPath('C:\\biosync_new\\vendor\\symfony\\debug-bundle/Resources/views', '!Debug');
        $a->addPath('C:\\biosync_new\\vendor\\symfony\\web-profiler-bundle/Resources/views', 'WebProfiler');
        $a->addPath('C:\\biosync_new\\vendor\\symfony\\web-profiler-bundle/Resources/views', '!WebProfiler');
        $a->addPath('C:\\biosync_new\\vendor\\symfony\\ux-turbo/templates', 'Turbo');
        $a->addPath('C:\\biosync_new\\vendor\\symfony\\ux-turbo/templates', '!Turbo');
        $a->addPath('C:\\biosync_new\\vendor\\symfony\\security-bundle/Resources/views', 'Security');
        $a->addPath('C:\\biosync_new\\vendor\\symfony\\security-bundle/Resources/views', '!Security');
        $a->addPath('C:\\biosync_new\\vendor\\symfony\\maker-bundle/templates', 'Maker');
        $a->addPath('C:\\biosync_new\\vendor\\symfony\\maker-bundle/templates', '!Maker');
        $a->addPath('C:\\biosync_new/templates');
        $a->addPath('C:\\biosync_new\\vendor\\symfony\\twig-bridge/Resources/views/Email', 'email');
        $a->addPath('C:\\biosync_new\\vendor\\symfony\\twig-bridge/Resources/views/Email', '!email');
        $a->addPath('C:\\biosync_new\\vendor\\symfony\\twig-bridge/Resources/views/Form');
        ...
        $instance->addExtension(new \Symfony\Bundle\WebProfilerBundle\Profiler\CodeExtension($h, 'C:\\biosync_new', 'UTF-8'));
    ...
    protected static function getValidator_BuilderService($container)
    {
        ...
        $instance->addXmlMappings(['C:\\biosync_new\\vendor\\symfony\\form/Resources/config/validation.xml']);
    ...
    {
        return [
            'kernel.project_dir' => 'C:\\biosync_new',
            ...
            'kernel.bundles_metadata' => [
                'FrameworkBundle' => [
                    'path' => 'C:\\biosync_new\\vendor\\symfony\\framework-bundle',
                    'namespace' => 'Symfony\\Bundle\\FrameworkBundle',
                ],
                'DoctrineBundle' => [
                    'path' => 'C:\\biosync_new\\vendor\\doctrine\\doctrine-bundle',
                    'namespace' => 'Doctrine\\Bundle\\DoctrineBundle',
                ],
                'DoctrineMigrationsBundle' => [
                    'path' => 'C:\\biosync_new\\vendor\\doctrine\\doctrine-migrations-bundle',
                    'namespace' => 'Doctrine\\Bundle\\MigrationsBundle',
                ],
                'DebugBundle' => [
                    'path' => 'C:\\biosync_new\\vendor\\symfony\\debug-bundle',
                    'namespace' => 'Symfony\\Bundle\\DebugBundle',
                ],
                'TwigBundle' => [
                    'path' => 'C:\\biosync_new\\vendor\\symfony\\twig-bundle',
                    'namespace' => 'Symfony\\Bundle\\TwigBundle',
                ],
                'WebProfilerBundle' => [
                    'path' => 'C:\\biosync_new\\vendor\\symfony\\web-profiler-bundle',
                    'namespace' => 'Symfony\\Bundle\\WebProfilerBundle',
                ],
                'StimulusBundle' => [
                    'path' => 'C:\\biosync_new\\vendor\\symfony\\stimulus-bundle',
                    'namespace' => 'Symfony\\UX\\StimulusBundle',
                ],
                'TurboBundle' => [
                    'path' => 'C:\\biosync_new\\vendor\\symfony\\ux-turbo',
                    'namespace' => 'Symfony\\UX\\Turbo',
                ],
                'TwigExtraBundle' => [
                    'path' => 'C:\\biosync_new\\vendor\\twig\\extra-bundle',
                    'namespace' => 'Twig\\Extra\\TwigExtraBundle',
                ],
                'SecurityBundle' => [
                    'path' => 'C:\\biosync_new\\vendor\\symfony\\security-bundle',
                    'namespace' => 'Symfony\\Bundle\\SecurityBundle',
                ],
                'MonologBundle' => [
                    'path' => 'C:\\biosync_new\\vendor\\symfony\\monolog-bundle\\src',
                    'namespace' => 'Symfony\\Bundle\\MonologBundle',
                ],
                'MakerBundle' => [
                    'path' => 'C:\\biosync_new\\vendor\\symfony\\maker-bundle',
                    'namespace' => 'Symfony\\Bundle\\MakerBundle',
                ],
                'DoctrineFixturesBundle' => [
                    'path' => 'C:\\biosync_new\\vendor\\doctrine\\doctrine-fixtures-bundle',
            ...
            'translator.default_path' => 'C:\\biosync_new/translations',
            ...
            'twig.default_path' => 'C:\\biosync_new/templates',
