...
class __TwigTemplate_d70fc3c0c672e85cca4bbb2f87094c91 extends Template
{
...
";
    ...
    if (typeof Sfjs === 'undefined' || typeof Sfjs.loadToolbar === 'undefined') {
        ...
        if (array_key_exists("excluded_ajax_paths", $context)) {
            ...
            // line 316
            yield json_encode((isset($context["excluded_ajax_paths"]) || array_key_exists("excluded_ajax_paths", $context) ? $context["excluded_ajax_paths"] : (function () { throw new RuntimeError('Variable "excluded_ajax_paths" does not exist.', 316, $this->source); })()));
            yield "))) {
                        var method = 'GET';
            ...
            // line 367
            yield json_encode((isset($context["excluded_ajax_paths"]) || array_key_exists("excluded_ajax_paths", $context) ? $context["excluded_ajax_paths"] : (function () { throw new RuntimeError('Variable "excluded_ajax_paths" does not exist.', 367, $this->source); })()));
            yield "))) {
                        var stackElement = {
                            error: false,
                            url: url,
    ...
    Sfjs.loadToolbar('";
        // line 652
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape((isset($context["token"]) || array_key_exists("token", $context) ? $context["token"] : (function () { throw new RuntimeError('Variable "token" does not exist.', 652, $this->source); })()), "html", null, true);
        yield "');
/*]]>*/</script>
";
    ...
    {
        return array (  744 => 652,  712 => 623,  626 => 540,  480 => 396,  448 => 367,  442 => 364,  438 => 363,  432 => 360,  428 => 359,  382 => 316,  361 => 297,  359 => 296,  72 => 17,  61 => 12,  56 => 9,  54 => 7,  53 => 2,  48 => 1,);
    }
...
/*]]>*/</script>
", "@WebProfiler/Profiler/toolbar_js.html.twig", "C:\\biosync_new\\vendor\\symfony\\web-profiler-bundle\\Resources\\views\\Profiler\\toolbar_js.html.twig");
    }
}
