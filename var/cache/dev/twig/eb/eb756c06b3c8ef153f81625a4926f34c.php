    ...
    ";
        ...
        foreach ($context['_seq'] as $context["label"] => $context["messages"]) {
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["message"]) {
                // line 26
                yield "            <div data-flash-message=\"";
                yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($context["message"], "html", null, true);
                yield "\" data-flash-type=\"";
...
";
    ...
    {
        return array (  206 => 30,  184 => 18,  162 => 15,  139 => 6,  126 => 31,  124 => 30,  121 => 29,  115 => 28,  104 => 26,  99 => 25,  94 => 24,  88 => 21,  85 => 19,  83 => 18,  79 => 16,  77 => 15,  71 => 13,  65 => 10,  59 => 6,  52 => 1,);
    }
...
<body>
    ...
    {% for label, messages in app.flashes %}
        {% for message in messages %}
            <div data-flash-message=\"{{ message }}\" data-flash-type=\"{{ label }}\" style=\"display:none;\"></div>
        {% endfor %}
    {% endfor %}
...
", "base.html.twig", "C:\\biosync_new\\templates\\base.html.twig");
    }
}
