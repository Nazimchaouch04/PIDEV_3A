...
class __TwigTemplate_2b33b68eadc3787afbee8ba3355b1825 extends Template
{
    ...
    ";
        ...
        <div class=\"sf-tabs js-tabs\">
            ...
            foreach ($context['_seq'] as $context["name"] => $context["data"]) {
                ...
                if ((($tmp = Twig\Extension\CoreExtension::length($this->env->getCharset(), CoreExtension::getAttribute($this->env, $this->source, $context["data"], "calls", [], "any", false, false, false, 268))) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
                    yield " (";
                ...
                foreach ($context['_seq'] as $context["_key"] => $context["call"]) {
                    ...
                    yield "()</code>
                                            ";
                    // line 297
                    if ((($tmp = (((CoreExtension::getAttribute($this->env, $this->source, $context["call"], "previousMarking", [], "any", true, true, false, 297) &&  !(null === CoreExtension::getAttribute($this->env, $this->source, $context["call"], "previousMarking", [], "any", false, false, false, 297)))) ? (CoreExtension::getAttribute($this->env, $this->source, $context["call"], "previousMarking", [], "any", false, false, false, 297)) : (null))) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
                        // line 298
                        yield "                                                <hr />
                                                Previous marking:
                                                ";
...
$context["call"], "return", [], "any", false, false, false, 310) === false)) {
                    ...
                    yield "                                        </td>
                                        <td>
                                            ";
                    // line 323
                    yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(Twig\Extension\CoreExtension::sprintf("%0.2f ms", CoreExtension::getAttribute($this->env, $this->source, $context["call"], "duration", [], "any", false, false, false, 323)), "html", null, true);
                    yield "
                                        </td>
                                    </tr>
                                ";
...
{% endblock %}
", "@WebProfiler/Collector/workflow.html.twig", "C:\\biosync_new\\vendor\\symfony\\web-profiler-bundle\\Resources\\views\\Collector\\workflow.html.twig");
    }
}
